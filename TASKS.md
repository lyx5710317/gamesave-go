...
- [ ] Add remote-state summaries, upload queue visibility, and actionable errors.
  ...
  - [x] Enumerate every Google Drive snapshot-list page and reject incomplete or cycling pagination before using the listing for upload decisions. Dropbox and OneDrive pagination and provider-atomic create-only writes remain pending.
